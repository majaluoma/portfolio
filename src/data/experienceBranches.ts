...
export const experienceBranches = [
  {
    title: 'Web Developer',
    description: 'Informal experience in full-stack development and devops',
    experience: [
      {
        name: 'Entrepreneur',
        ...
        icon: coding,
        description:
          'Web development, project management, social networking and sales. Main tools include React, Node.js, Express, MySQL, Git and Cpanel',
    ...
    experience: [
      {
        ...
        icon: haagaHelia,
        description:
          'I have specialized in webdevelopment but also infrastructure and cyber security. Right now I am searching for my last trainee position to finish my studies.',
