export const blogData = [
  {
    id:1,
    title: 'With Salt, you can control other devices connected to the network.',
    ingress: 'Web development from Finnish context - no LLM used',
  ...
  {
    id:3,
    title: 'OpenTTD as Infrastructure as Code',
    ingress: 'OpenTTD game server on the target machine using Saltstack',
